...
function Login () {
    ...
    useEffect(()=>{
      if(localStorage.getItem('token')) history.push('/employees/')
    },[])
  ...
  return (
    ...
    <div className='w-max m-auto flex h-screen'>
      ...
      <form className='bg-blue-300 max-w-xl rounded px-20 pt-6 pb-6 m-auto shadow-2xl' onSubmit={submit}>
        <div className='mb-4'>
        <label
        ...
        <div className='flex items-center justify-between'>
          <button
            className='m-auto bg-blue-700 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded focus:outline-none hover:-translate-y-1 hover:opacity-80
